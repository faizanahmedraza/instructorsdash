<li class="nav-item {{ (request()->is('all-events.comment.index')) ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('all-events.comment.index') }}">
...
<li class="nav-item {{ (request()->is('events*')) ? 'active' : '' }}">
    ...
    <div id="collapseEvents" class="collapse {{ (request()->is('events*')) ? 'show' : '' }}"
        ...
        <div class="py-2 collapse-inner rounded">
            <a class="collapse-item {{ routeName() == 'events.index' ? 'active' : '' }}"
...
<li class="nav-item {{ (request()->is('guests')) ? 'active' : '' }}">
    ...
    <div id="collapseEventGuests" class="collapse {{ (request()->is('guests')) ? 'show' : '' }}"
        ...
        <div class="py-2 collapse-inner rounded">
            <a class="collapse-item {{ routeName() == 'guests.index' ? 'active' : '' }}"
