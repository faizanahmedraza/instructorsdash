                        ...
                        <div class="col-md-6">
							...
							<form action="{{ route('events.public.register', ['slug' => $event->short_slug]) }}" method="post" class="form-register">
								...
								<div class="form-group">
									<input type="text" name="fullname" value="{{ old('fullname', '') }}" placeholder="@lang('Fullname *')" class="form-control" required>
								</div>
								
								<div class="form-group">
									<input type="email" name="email" value="{{ old('email', '') }}" placeholder="@lang('Email *')" class="form-control" required>
								</div>
