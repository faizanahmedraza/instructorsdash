...
<head>
    ...
    @endif
    <link rel="stylesheet" href="{{ asset('modules/events/event_templates/strong/checkout.css') }}">
    <script src="{{ asset('modules/events/event_templates/strong/checkout.js') }}"></script>
